 ...
 *
 * Renders a spinning 3D particle sphere on the #canvasOne element using
 * raw Canvas 2D.  The radius can be adjusted via sliders (if present).
 *
 * Original authors:  https://github.com/jscottsmith/canvas-particle-sphere
 */
  ...
  function onTimer() {
    ...
    if (count >= wait) {
      ...
      for (i = 0; i < numToAddEachFrame; i++) {
        ...
        var p = addParticle(
          x0, sphereCenterY + y0, sphereCenterZ + z0,
...
// Optional sliders for radius control
$(function () {
  try {
    $("#slider-range").slider({
      range: false,
